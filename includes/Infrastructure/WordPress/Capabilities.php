 ...
 *
 * The capability is granted dynamically to anyone who can already manage
 * options, rather than written into role records. That keeps activation and
 * uninstall free of role mutations, and means the grant cannot be left behind
 * on a site after the plugin is removed.
 */
final class Capabilities {
	...
	public function register() {
		add_filter( 'user_has_cap', array( $this, 'grant_capability' ), 10, 4 );
	}
	 ...
	 * @return array
	 */
	public function grant_capability( $allcaps, $caps, $args, $user = null ) {
